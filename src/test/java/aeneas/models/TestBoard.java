...
public class TestBoard {
  ...
  public void testRelease() {
    ...
    numbers.add(new ReleaseNumber(0, 0, ReleaseNumber.color1, 1));
    numbers.add(new ReleaseNumber(1, 0, ReleaseNumber.color2, 1));
    numbers.add(new ReleaseNumber(2, 0, ReleaseNumber.color3, 1));
